...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login Page - Desk Solution Admin</title>
                        ...
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    ...
                                    <span class="red">Desk Solution</span>
                                    <span class="white" id="id-text2">Admin</span>
                                </h1>
                                <h4 class="blue" id="id-company-text">&copy; Company Website</h4>
                            </div>
                                            ...
                                            <fieldset>
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input type="text" class="form-control" name="admin_email_address" placeholder="Email" />
