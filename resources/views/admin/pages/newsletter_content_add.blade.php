...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="{{URL::to('add-newsletter-content')}}">Add News Letter Content</a></li>
    </ul>
    <!-- /.breadcrumb -->
                ...
                <div class="col-xs-12 widget-container-col">
                    <div class="widget-box">
                        <div class="widget-header">
                            <h5 class="widget-title">Add News Letter Content ...</h5>
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <div class="row">
                                    ...
                                    {!! Form::open(['url' => '/save-newsletter-content','method'=>'post','enctype'=>'multipart/form-data']) !!}
                                    <div class="col-xs-12">
                                        <div class="col-lg-6 col-sm-6">
                                            <label class="col-md-4" for="form-field-1">Heading</label>
                                            <div class="col-md-8">
                                                <input type="text" name='heading' class="form-control" id="form-field-8" placeholder="Heading" required></input>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-sm-6">
                                            <label class="col-md-4" for="form-field-1">Details</label>
                                            <div class="col-md-8">
                                                <textarea name='details' class="form-control" id="form-field-8" placeholder="Details" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12">                                        
